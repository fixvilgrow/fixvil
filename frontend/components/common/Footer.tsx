        ...
        */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4 cursor-pointer">
              <img src="/fixvil_logo.png" alt="Fixvil" className="w-8 h-8 rounded-lg" />
              <span className="font-bold text-xl text-white tracking-tight">Fixvil</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/guidelines" className="hover:text-[#16a34a] transition-colors text-xs text-gray-400 font-medium">Guidelines</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/privacy-policy" className="hover:text-[#16a34a] transition-colors text-xs text-gray-400 font-medium">Privacy Policy</a></li>
              <li><a href="/terms-and-conditions" className="hover:text-[#16a34a] transition-colors text-xs text-gray-400 font-medium">Terms and condition</a></li>
            ...
            <ul className="space-y-4">
              <li>
                <div className="flex items-start gap-2 text-xs text-gray-400 hover:text-[#16a34a] transition-colors font-medium">
                  ...
                  <a href="mailto:hello@fixvil.in">hello@fixvil.in</a>
                </div>
              </li>
              <li>
                <div className="flex items-start gap-2 text-xs text-gray-400 hover:text-[#16a34a] transition-colors font-medium">
        ...
        <div className="pt-6 border-t border-gray-800 flex items-center justify-center">
          <p className="text-xs text-gray-500 font-medium">
            &copy; 2026 Fixvil Automation Solutions. All rights reserved.
          </p>
        </div>
